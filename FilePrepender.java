    ...
    public static void main (String [] args)
    {
        ...
        try {
            ...
            if (megaDumpFile.createNewFile()) {
                System.out.println("Master dump file creation success");
            } else {
                System.out.println("Master dump file was not made. File already exists. Please check and re-run");
            }
